...
public class SplineClaimTriangleSmoothable extends LinearSmoothable<FactorTriangle> {
    ...
    static class DialogController extends SplineSmoothingDialogController<FactorTriangle> {
