 ...
 * @version 1.0
 */
public class AdjustedResidualTriangleTest {
    ...
    private AdjustedResidualTriangle residuals;
    ...
    public void setUp() {
        ...
        residuals = new AdjustedResidualTriangle(new LinkRatioResiduals(scales));
    }
    
    @Test
    public void testGetAdjustment() {
        int devs = cik.getDevelopmentCount() - 1;
