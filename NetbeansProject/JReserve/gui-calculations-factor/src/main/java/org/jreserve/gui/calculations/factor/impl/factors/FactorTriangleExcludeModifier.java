...
import org.jreserve.gui.calculations.factor.FactorTriangleModifier;
...
@Messages({
    "# {0} - accident",
    "# {1} - development",
    "LBL.FactorTriangleExcludeModifier.Description=Exclusion [{0}; {1}]",
    "LBL.FactorTriangleExcludeModifier.Name=Exclusion"
})
public class FactorTriangleExcludeModifier extends AbstractCalculationModifier<FactorTriangle> implements FactorTriangleModifier {
    final static String ROOT_ELEMENT = "factorTriangleExclusion";
    ...
    public FactorTriangle createCalculation(FactorTriangle sourceCalculation) {
        return new FactorTriangleCorrection(sourceCalculation, accident, development, Double.NaN);
    }
    ...
    public String getDescription() {
        return Bundle.LBL_FactorTriangleExcludeModifier_Description(
    ...
    private static class ExclusionDisplayable implements Displayable {
        ...
        public String getDisplayName() {
            return Bundle.LBL_FactorTriangleExcludeModifier_Name();
        }
    }
}
