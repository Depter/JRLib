...
public class OfficeRibbonUI extends BasicRibbonUI {
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        this.paintTaskArea(g, 0, ins.top + extraHeight - 1, c.getWidth(), c.getHeight() - extraHeight - ins.top);
    }
    ...
    protected void paintTaskArea(Graphics g, int x, int y, int width, int height) {
        ...
        if(taskBackgroundCache == null || width != taskBackgroundCache.getWidth() || height != taskBackgroundCache.getHeight()) {
            ...
            drawTaskAreaGradient(ig, width, height);
            ig.dispose();
        }
    ...
    protected static void drawTaskAreaGradient(Graphics2D g, int width, int height) {
        int r = width - 1;
        int b = height - 1;
        int s = 3; // shadow size
        ...
        g.setPaint(new LinearGradientPaint(0, 1, 0, 17, new float[]{0, 1}, new Color[]{taskAreaBg1, taskAreaBg2}));
        g.fillRect(1, 1, width - 2, 16);

        // Paint the bottom background gradient
        g.setPaint(new LinearGradientPaint(0, 17, 0, b, new float[]{0, 1}, new Color[]{taskAreaBg3, taskAreaBg4}));
        g.fillRect(1, 17, width - 2, height - 18 - s);

        // Paint the border
        float[] fractions = {0, 1};
        Color[] borderColors = {gray_0, gray};
        g.setPaint(new LinearGradientPaint(0, 0, 4, 0, fractions, borderColors));
        g.drawLine(0, 0, r - 5, 0); // top line with fadeout at the left
        g.drawLine(0, b, r - 5, b); // bottom line with fadeout at the left
        g.setPaint(new LinearGradientPaint(r, 0, r - 4, 0, fractions, borderColors));
        g.drawLine(r - 4, 0, r, 0); // top line right fadeout
        g.drawLine(r - 4, b, r, b); // bottom line right fadeout
        g.setPaint(new LinearGradientPaint(0, 0, 0, 4, fractions, borderColors));
        g.drawLine(0, 0, 0, b - 5); // left line with fadeout at the top
        g.drawLine(r, 0, r, b - 5); // right line with fadeout at the top
        g.setPaint(new LinearGradientPaint(0, b, 0, b - 4, fractions, borderColors));
        g.drawLine(0, b - 4, 0, b); // left line bottom fadeout
        g.drawLine(r, b - 4, r, b); // right line bottom fadeout

        // Paint the bottom inner shadow
        g.setColor(gray2);
        g.drawLine(1, b - 2, r - 1, b - 2);
        g.setColor(gray3);
        g.drawLine(2, b - 1, r - 2, b - 1);

        // Paint the corners of the border
        g.setColor(gray);
        g.drawLine(1, 1, 1, 1); // tl
        g.drawLine(1, b - 1, 1, b - 1); // bl
        g.drawLine(r - 1, 1, r - 1, 1); // tr
        g.drawLine(r - 1, b - 1, r - 1, b - 1); // br
        g.setColor(gray_110);
        g.drawLine(1, 2, 1, 2); // tl
        g.drawLine(2, 1, 2, 1);
        g.drawLine(r - 1, 2, r - 1, 2); // tr
        g.drawLine(r - 2, 1, r - 2, 1);
        g.drawLine(r - 1, b - 2, r - 1, b - 2); // br
        g.drawLine(r - 2, b - 1, r - 2, b - 1);
        g.drawLine(1, b - 2, 1, b - 2); // bl
        g.drawLine(2, b - 1, 2, b - 1);

        // Paint the bottom shadow
        b += s;
        g.setPaint(new LinearGradientPaint(0, b - 2, 4, b - 2, fractions, new Color[]{black_0, black_69}));
        g.drawLine(0, b - 2, r - 5, b - 2);
        g.setPaint(new LinearGradientPaint(r, b - 2, r - 4, b - 2, fractions, new Color[]{black_0, black_69}));
        g.drawLine(r - 4, b - 2, r, b - 2);
        g.setPaint(new LinearGradientPaint(0, b - 1, 4, b - 1, fractions, new Color[]{black_0, black_48}));
        g.drawLine(0, b - 1, r - 5, b - 1);
        g.setPaint(new LinearGradientPaint(r, b - 1, r - 4, b - 1, fractions, new Color[]{black_0, black_48}));
        g.drawLine(r - 4, b - 1, r, b - 1);
    }
     ...
     */
    protected class OfficeTaskToggleButtonsHostPanel extends TaskToggleButtonsHostPanel {
     ...
     */
    protected class OfficeBandHostPanel extends BandHostPanel {
