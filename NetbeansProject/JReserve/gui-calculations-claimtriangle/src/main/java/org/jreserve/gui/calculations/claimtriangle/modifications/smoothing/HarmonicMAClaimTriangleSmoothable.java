...
public class HarmonicMAClaimTriangleSmoothable extends AbstractMASmoothable<ClaimTriangle> {
    ...
    private static class DialogController extends MASmoothingDialogController<ClaimTriangle> {
