...
class VectorNode extends DataNode {

    @StaticResource final static String IMG = "org/jreserve/gui/calculations/vector/vector.png";
    public final static String ACTION_PATH = "Node/VectorNode/Actions";  //NOI18
    
    private final InstanceContent ic;
    
    public VectorNode(VectorDataObject obj) {
        this(obj, new InstanceContent());
    }
    
    private VectorNode(VectorDataObject obj, InstanceContent ic) {
    ...
    public Node cloneNode() {
        return new VectorNode((VectorDataObject) getDataObject());
    }
