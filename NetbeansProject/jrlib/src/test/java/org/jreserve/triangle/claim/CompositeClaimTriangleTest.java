 ...
 * @version 1.0
 */
public class CompositeClaimTriangleTest {
    ...
    private ClaimTriangle count;
    private CompositeClaimTriangle triangle;
    
    public CompositeClaimTriangleTest() {
    }
    ...
    public void setUp() {
        ...
        triangle = new CompositeClaimTriangle(paid, count, TriangleOperation.DIVIDE);
    }
