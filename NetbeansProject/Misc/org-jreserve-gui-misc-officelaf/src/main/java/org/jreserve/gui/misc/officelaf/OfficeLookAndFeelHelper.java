...
public class OfficeLookAndFeelHelper {
    ...
    public Object[] getClassDefaults() {
        final String uiClassnamePrefix       = "org.jreserve.gui.misc.officelaf.Office";
        final String uiRibbonClassnamePrefix = "org.jreserve.gui.misc.officelaf.ribbon.Office";

        return new Object[] {
            "PanelUI",                       uiClassnamePrefix + "PanelUI",
            "RootPaneUI",                    uiClassnamePrefix + "RootPaneUI",

            "CommandButtonUI",               uiRibbonClassnamePrefix + "CommandButtonUI",
            "CommandToggleButtonUI",         uiRibbonClassnamePrefix + "CommandToggleButtonUI",
            "CommandMenuButtonUI",           uiRibbonClassnamePrefix + "CommandMenuButtonUI",
            "CommandButtonPanelUI",          uiRibbonClassnamePrefix + "CommandButtonPanelUI",
            "RibbonUI",                      uiRibbonClassnamePrefix + "RibbonUI",
            "RibbonBandUI",                  uiRibbonClassnamePrefix + "RibbonBandUI",
            "BandControlPanelUI",            uiRibbonClassnamePrefix + "BandControlPanelUI",
            "RibbonTaskToggleButtonUI",      uiRibbonClassnamePrefix + "RibbonTaskToggleButtonUI",
            "RibbonApplicationMenuButtonUI", uiRibbonClassnamePrefix + "RibbonApplicationMenuButtonUI"
        };
    }
