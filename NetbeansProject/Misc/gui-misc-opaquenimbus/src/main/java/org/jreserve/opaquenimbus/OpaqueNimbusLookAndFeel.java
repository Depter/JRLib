...
public class OpaqueNimbusLookAndFeel extends SynthLookAndFeel {
     ...
     * visual designer.
     */
    private OpaqueNimbusDefaults defaults;
     ...
     */
    public OpaqueNimbusLookAndFeel() {
        super();
        defaults = new OpaqueNimbusDefaults();
    }
    ...
    @Override public void uninitialize() {
        ...
        OpaqueNimbusStyle.uninitialize();
    }
    ...
    @Override public UIDefaults getDefaults() {
        if (uiDefaults == null){
            ...
            uiDefaults.put("TitledBorder.font",
                    new OpaqueNimbusDefaults.DerivedFont("defaultFont", 
                            1f, true, null));
