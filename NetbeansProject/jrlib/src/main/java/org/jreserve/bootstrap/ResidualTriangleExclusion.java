 ...
 * @version 1.0
 */
public class ResidualTriangleExclusion extends AbstractTriangleModification<ResidualTriangle> implements ResidualTriangleModification  {

    private boolean[][] exclusions = new boolean[0][];
    
    public ResidualTriangleExclusion(ResidualTriangle source) {
        super(source);
    }
