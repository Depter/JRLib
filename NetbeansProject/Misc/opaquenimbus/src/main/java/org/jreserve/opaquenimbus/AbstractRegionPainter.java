...
public abstract class AbstractRegionPainter implements Painter<JComponent> {
    ...
    */
    ...
    protected final Color decodeColor(String key, float hOffset, float sOffset,
        ...
        if (UIManager.getLookAndFeel() instanceof OpaqueNimbusLookAndFeel){
            OpaqueNimbusLookAndFeel laf = (OpaqueNimbusLookAndFeel) UIManager.getLookAndFeel();
    ...
    protected final Color decodeColor(Color color1, Color color2,
                                      float midPoint) {
        return new Color(OpaqueNimbusLookAndFeel.deriveARGB(color1, color2, midPoint));
    }
