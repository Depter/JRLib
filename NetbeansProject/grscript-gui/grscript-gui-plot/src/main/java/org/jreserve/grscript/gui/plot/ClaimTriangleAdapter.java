...
//)
//@Messages({
//    "LBL.ClaimTriangleAdapter.Name=ClaimTriangleAdapter"
//})
public class ClaimTriangleAdapter extends AbstractFunctionProviderAdapter {
    
    private final static String HELP_ID = "org.jreserve.grscript.gui.plot.claimTriangle";

    @Override
    protected FunctionProvider createFunctionProvider() {
        return new ClaimTrianglePlotDelegate();
    }
