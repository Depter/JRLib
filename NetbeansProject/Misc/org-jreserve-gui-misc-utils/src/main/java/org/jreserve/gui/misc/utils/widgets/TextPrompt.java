 ...
 * TextPrompt prompt = new TextPrompt("Search", textField);
 * prompt.setForeground(Color.GREY);
...
public class TextPrompt extends JLabel {
    ...
    public TextPrompt(String text, JTextComponent component) {
        this(text, component, PromptStyle.FOCUS_LOST);
    }

    public TextPrompt(String text, JTextComponent component, PromptStyle show) {
        ...
        component.addFocusListener(new TextFocusListener());
     ...
     */
    public void setShow(PromptStyle show) {
        this.promptStyle = show;
    }
    ...
    private void checkForPrompt() {
        ...
        if (component.hasFocus()) {
            if (promptStyle == PromptStyle.ALWAYS
                    || promptStyle == PromptStyle.FOCUS_GAINED) {
                setVisible(true);
            } else {
                setVisible(false);
            }
            ...
            if (promptStyle == PromptStyle.ALWAYS
                    || promptStyle == PromptStyle.FOCUS_LOST) {
                setVisible(true);
            } else {
                setVisible(false);
            }
