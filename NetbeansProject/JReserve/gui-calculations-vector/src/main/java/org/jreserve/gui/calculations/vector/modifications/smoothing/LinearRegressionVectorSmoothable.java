...
@Smoothable.Registration(
    ...
    displayName = "#LBL.LinearRegressionVectorSmoothable.Name",
    position = 500, 
    separatorBefore = true
)
@Messages({
    "LBL.LinearRegressionVectorSmoothable.Name=Linear Regression"
})
public class LinearRegressionVectorSmoothable extends LinearSmoothable<Vector> {
    ...
    static class DialogController extends LinearRegressionDialogController<Vector> {
