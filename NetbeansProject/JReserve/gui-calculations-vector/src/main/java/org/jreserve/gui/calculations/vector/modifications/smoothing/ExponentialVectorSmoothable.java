...
@Smoothable.Registration(
    ...
    displayName = "#LBL.ExponentialVectorSmoothable.Name",
    position = 100
)
@Messages({
    "LBL.ExponentialVectorSmoothable.Name=Exponential Smoothing"
})
public class ExponentialVectorSmoothable extends ExponentialSmoothable<Vector> {
    ...
    static class DialogController extends ExponentialSmoothingDialogController<Vector> {

        DialogController(Vector vector, TriangleGeometry geometry, List<Cell> cells) {
