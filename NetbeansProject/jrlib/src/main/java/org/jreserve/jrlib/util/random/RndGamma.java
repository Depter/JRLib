...
/**
 * Utility class to generate random gamma variables.
 * 
...
public class RndGamma {
    ...
    /**
     * Creates a new instance, using the given {@link Random Random} instance.
     * 
    ...
    /**
     * Returns a random gamma variable, with the given mean and variance.
     */
    ...
    /**
     * Returns a random gamma variable, with the given alpha and lambda parameters.
     * 
     * <p>The parameters can be calculated as:
     * <pre><code>
     *               mean
     *     lambda = --------
     *              variance
    ...
    private boolean isValidInput(double alpha, double lambda) {
        return !Double.isNaN(alpha) && alpha > 0d &&
               !Double.isNaN(lambda) && lambda > 0d;
    }
