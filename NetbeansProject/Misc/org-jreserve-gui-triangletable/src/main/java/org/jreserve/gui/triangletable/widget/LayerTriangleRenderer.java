 ...
 * @version 1.0
 */
class LayerTriangleRenderer implements TriangleWidgetRenderer {

    private TriangleWidget widget;
    private DefaultTriangleWidgetRenderer baseRenderer = new DefaultTriangleWidgetRenderer();
    
    LayerTriangleRenderer(TriangleWidget widget) {
        this.widget = widget;
    }
