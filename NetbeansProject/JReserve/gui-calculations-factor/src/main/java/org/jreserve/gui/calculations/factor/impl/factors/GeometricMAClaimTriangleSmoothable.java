...
public class GeometricMAClaimTriangleSmoothable extends AbstractMASmoothable<FactorTriangle> {
    ...
    static class DialogController extends MASmoothingDialogController<FactorTriangle> {
        ...
        public DialogController(FactorTriangle triangle, TriangleGeometry geometry, List<Cell> cells) {
            super(triangle, geometry, cells, Bundle.LBL_GeometricMAClaimTriangleSmoothable_Name());
        }
