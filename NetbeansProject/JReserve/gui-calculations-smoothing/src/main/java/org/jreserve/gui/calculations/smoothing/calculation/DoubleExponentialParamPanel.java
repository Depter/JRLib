 ...
 * @version 1.0
 */
class DoubleExponentialParamPanel extends javax.swing.JPanel {

    private final DoubleExponentialSmoothingDialogController controller;
    private TextListener textListener = new TextListener();
    
    DoubleExponentialParamPanel(DoubleExponentialSmoothingDialogController controller) {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(alphaLabel, org.openide.util.NbBundle.getMessage(DoubleExponentialParamPanel.class, "DoubleExponentialParamPanel.alphaLabel.text")); // NOI18N
        ...
        alphaText.getDocument().addDocumentListener(textListener);
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(betaLabel, org.openide.util.NbBundle.getMessage(DoubleExponentialParamPanel.class, "DoubleExponentialParamPanel.betaLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        betaText.setColumns(10);
        betaText.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        betaText.setText(null);
        betaText.getDocument().addDocumentListener(textListener);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 10, 0);
        add(betaText, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(msgLabel, org.openide.util.NbBundle.getMessage(DoubleExponentialParamPanel.class, "DoubleExponentialParamPanel.msgLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
