...
public class LinearRegressionClaimTriangleSmoothable extends LinearSmoothable<FactorTriangle> {
    ...
    static class DialogController extends LinearRegressionDialogController<FactorTriangle> {
