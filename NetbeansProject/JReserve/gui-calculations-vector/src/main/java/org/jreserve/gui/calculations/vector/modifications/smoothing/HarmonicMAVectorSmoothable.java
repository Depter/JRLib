...
@Smoothable.Registration(
    ...
    displayName = "#LBL.HarmonicMAVectorSmoothable.Name",
    position = 500
)
@Messages({
    "LBL.HarmonicMAVectorSmoothable.Name=Harmonic MA"
})
public class HarmonicMAVectorSmoothable extends AbstractMASmoothable<Vector> {
    ...
    static class DialogController extends MASmoothingDialogController<Vector> {
        ...
        public DialogController(Vector vector, TriangleGeometry geometry, List<Cell> cells) {
            super(vector, geometry, cells, Bundle.LBL_HarmonicMAVectorSmoothable_Name());
        }
