 ...
 */
@ConvertAsProperties(
    dtd = "-//org.jreserve.grscript.gui.classpath//ClassPathExplorer//EN",
    autostore = false
)
...
@ActionID(
    category = "Window", 
    id = "org.jreserve.grscript.gui.classpath.ClassPathExplorerTopComponent"
)
@ActionReference(
    path = "Menu/Window", 
    position = 100 
...
@Messages({
    ...
    "HINT_ClassPathExplorerTopComponent=Classpath elements"
})
public final class ClassPathExplorerTopComponent extends TopComponent {
