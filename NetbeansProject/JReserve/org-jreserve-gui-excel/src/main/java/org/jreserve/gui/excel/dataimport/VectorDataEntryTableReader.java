 ...
 * @version 1.0
 */
public class VectorDataEntryTableReader extends DataEntryTableReader {
    
    private MonthDate accident;
    
    @Override
    public void numberFound(int row, short column, double value) {
    ...
    private void createEntry(int row, double value) {
        ...
        addEntry(row, new DataEntry(accident, value));
    }
}
