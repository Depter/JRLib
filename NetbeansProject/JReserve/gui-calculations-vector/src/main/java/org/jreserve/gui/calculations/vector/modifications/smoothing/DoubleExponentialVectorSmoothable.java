...
@Smoothable.Registration(
    ...
    displayName = "#LBL.DoubleExponentialVectorSmoothable.Name",
    position = 200
)
@Messages({
    "LBL.DoubleExponentialVectorSmoothable.Name=Double Exp. Smoothing"
})
public class DoubleExponentialVectorSmoothable extends DoubleExponentialSmoothable<Vector> {
    ...
    static class DialogController extends DoubleExponentialSmoothingDialogController<Vector> {
