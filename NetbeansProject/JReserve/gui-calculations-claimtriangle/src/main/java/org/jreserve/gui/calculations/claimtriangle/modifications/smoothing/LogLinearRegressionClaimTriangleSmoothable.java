...
public class LogLinearRegressionClaimTriangleSmoothable extends LinearSmoothable<ClaimTriangle> {
    ...
    private static class DialogController extends LogLinearRegressionDialogController<ClaimTriangle> {
