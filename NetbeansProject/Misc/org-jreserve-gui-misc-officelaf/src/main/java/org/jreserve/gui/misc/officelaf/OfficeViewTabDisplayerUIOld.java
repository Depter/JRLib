package org.jreserve.gui.misc.officelaf;
...
//    private static final Color BG4_FOCUSED_COLOR = new Color(0xf3e5b1);
    ...
    private static void initIcons() {
        if (null == buttonIconPaths) {
            ...
            String dir = "org/netbeans/swing/tabcontrol/resources/";
            
            //close button
            buttonIconPaths.put(TabControlButton.ID_CLOSE_BUTTON, createIconPath("bigclose"));
            //slide/pin button
            buttonIconPaths.put(TabControlButton.ID_SLIDE_RIGHT_BUTTON, createIconPath("slideright"));
            buttonIconPaths.put(TabControlButton.ID_SLIDE_LEFT_BUTTON, createIconPath("slideleft"));
            buttonIconPaths.put(TabControlButton.ID_SLIDE_DOWN_BUTTON, createIconPath("slidebottom"));
            buttonIconPaths.put(TabControlButton.ID_PIN_BUTTON, createIconPath("pin"));
            //Scroll
            buttonIconPaths.put(TabControlButton.ID_SCROLL_LEFT_BUTTON, createIconPath("scrollleft"));
            buttonIconPaths.put(TabControlButton.ID_SCROLL_RIGHT_BUTTON, createIconPath("scrollright"));
            
            buttonIconPaths.put(TabControlButton.ID_MAXIMIZE_BUTTON, createIconPath("maximize"));
            buttonIconPaths.put(TabControlButton.ID_RESTORE_BUTTON, createIconPath("restore"));
            buttonIconPaths.put(TabControlButton.ID_RESTORE_GROUP_BUTTON, createIconPath("restore_group"));
            buttonIconPaths.put(TabControlButton.ID_SLIDE_GROUP_BUTTON, createIconPath("minimize"));
            buttonIconPaths.put(TabControlButton.ID_DROP_DOWN_BUTTON, createIconPath("popup"));
        }
    }
    
    private static String[] createIconPath(String name) {
        String dir = "org/netbeans/swing/tabcontrol/resources/";
        String[] path = new String[4];
        path[TabControlButton.STATE_DEFAULT] = dir + "xp_"+name+"_enabled.png"; // NOI18N
        path[TabControlButton.STATE_PRESSED] = dir + "xp_"+name+"_pressed.png"; // NOI18N
        path[TabControlButton.STATE_DISABLED] = path[TabControlButton.STATE_DEFAULT];
        path[TabControlButton.STATE_ROLLOVER] = dir + "xp_"+name+"_rollover.png"; // NOI18N
        return path;
    }
