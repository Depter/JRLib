 ...
 */
@Messages({
    "LBL.CreateFactorVisualPanel1.Name=Name & Location",
    "PROMPT.CreateFactorVisualPanel1.Name=Select name",
    "PROMPT.CreateFactorVisualPanel1.Folder=Select location"
})
class CreateFactorVisualPanel1 extends javax.swing.JPanel {

    private final CreateFactorWizardPanel1 controller;
    private NamedCalculationProvider cop;
    private TextListener textListener = new TextListener();
            
    CreateFactorVisualPanel1(CreateFactorWizardPanel1 controller) {
    ...
    public String getName() {
        return Bundle.LBL_CreateFactorVisualPanel1_Name();
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(projectLabel, org.openide.util.NbBundle.getMessage(CreateFactorVisualPanel1.class, "CreateFactorVisualPanel1.projectLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(nameLabel, org.openide.util.NbBundle.getMessage(CreateFactorVisualPanel1.class, "CreateFactorVisualPanel1.nameLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_LEADING;
        ...
        TextPrompt.createStandard(Bundle.PROMPT_CreateFactorVisualPanel1_Name(), nameText);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(folderLabel, org.openide.util.NbBundle.getMessage(CreateFactorVisualPanel1.class, "CreateFactorVisualPanel1.folderLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_LEADING;
        ...
        TextPrompt.createStandard(Bundle.PROMPT_CreateFactorVisualPanel1_Folder(), folderText);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        ...
        org.openide.awt.Mnemonics.setLocalizedText(browseButton, org.openide.util.NbBundle.getMessage(CreateFactorVisualPanel1.class, "CreateFactorVisualPanel1.browseButton.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(pathLabel, org.openide.util.NbBundle.getMessage(CreateFactorVisualPanel1.class, "CreateFactorVisualPanel1.pathLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_LEADING;
