...
public class ExponentialLRFunctionTest {
    ...
    public void testFit_Paid() {
        ...
        ef.fit(lr);
        assertEquals(0.139573203, ef.getA(), JRLibTestUtl.EPSILON);
        assertEquals(0.667524784, ef.getB(), JRLibTestUtl.EPSILON);
    }
    ...
    public void testFit_Incurred() {
        ...
        ef.fit(lr);
        assertEquals(0.849803581, ef.getA(), JRLibTestUtl.EPSILON);
        assertEquals(1.212596053, ef.getB(), JRLibTestUtl.EPSILON);
    }

    @Test
    public void testGetA() {
        assertEquals(1d, ef.getA(), JRLibTestUtl.EPSILON);
    }

    @Test
    public void testGetB() {
        assertEquals(1d, ef.getB(), JRLibTestUtl.EPSILON);
    }
    ...
    public void testGetValue() {
        ...
        for(int d=0; d<7; d++)
            assertEquals(expected[d], ef.getValue(d), JRLibTestUtl.EPSILON);
    }
